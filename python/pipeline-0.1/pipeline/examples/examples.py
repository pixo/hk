...
#         core.hktask.createShotTask(db, "testing_sq01_sh100_%s_main" % doc_id, "ceci est la tache %s" % doc_id)
    ...
    core.hktask.createAssetTask(db, "testing_chr_mickey_lit_main" , "ceci est la tache lit") 
    ...
    core.hktask.createAssetTask(db, "testing_chr_mickey_dmp_main" , "ceci est la tache dmp") 
    core.hktask.createAssetTask(db, "testing_chr_mickey_lay_main" , "ceci est la tache lay") 
    core.hktask.createAssetTask(db, "testing_chr_mickey_cam_main" , "ceci est la tache cam") 
    ...
    core.hktask.createAssetTask(db, "testing_chr_mickey_cmp_main" , "ceci est la tache cmp")

    core.hktask.createShotTask(db, "testing_sq02_sh100_lit_main" , "ceci est la tache lit") 
    core.hktask.createShotTask(db, "testing_sq02_sh100_srf_main" , "ceci est la tache srf") 
    core.hktask.createShotTask(db, "testing_sq02_sh100_tex_main" , "ceci est la tache tex") 
    ...
    core.hktask.createShotTask(db, "testing_sq02_sh100_rig_main" , "ceci est la tache rig") 
    core.hktask.createShotTask(db, "testing_sq02_sh100_mod_main" , "ceci est la tache mod") 
